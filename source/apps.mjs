...
export const apps = [
  ...
  },
  {
    ...
    screenshotAspect: "portrait",
    accent: "cyan",
    featuresTitle: { fr: "Le carnet de vos véhicules", en: "Your vehicles’ logbook" },
    summary: {
