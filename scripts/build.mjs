...
function homePage(lang) {
  ...
  <section class="section"><div class="shell"><div class="section-heading"><div><p class="eyebrow">${fr ? "À découvrir" : "Featured"}</p><h2>${fr ? "Applications mises en avant" : "Featured applications"}</h2></div><a class="text-link" href="${langPath(lang, "/apps/")}">${fr ? "Voir les 7 applications" : "View all 7 applications"}<span aria-hidden="true"> →</span></a></div><div class="app-grid">${featured.map((app) => appCard(app, lang)).join("")}</div></div></section>
