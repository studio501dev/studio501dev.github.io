...
function homePage(lang) {
  ...
  <section class="section"><div class="shell"><div class="section-heading"><div><p class="eyebrow">${fr ? "À découvrir" : "Featured"}</p><h2>${fr ? "Applications mises en avant" : "Featured applications"}</h2></div><a class="text-link" href="${langPath(lang, "/apps/")}">${fr ? "Voir les 6 applications" : "View all 6 applications"}<span aria-hidden="true"> →</span></a></div><div class="app-grid">${featured.map((app) => appCard(app, lang)).join("")}</div></div></section>
...
function platformPage(lang, platformKey) {
  ...
  const description = isWindows ? (fr ? "Applications Studio501 pour Windows : Decision Tree Studio et Universal Converter Studio." : "Studio501 applications for Windows: Decision Tree Studio and Universal Converter Studio.") : (fr ? "Applications Android Studio501 : Ma Liste de Courses, Budget Assistant, MyHomeAssistant et Memoa." : "Studio501 Android applications: Ma Liste de Courses, Budget Assistant, MyHomeAssistant and Memoa.");
  const intro = isWindows ? {
    ...
    kicker: "Studio501 · Google Play", heading: fr ? "Applications Android" : "Android applications", lead: fr ? "Deux applications premium sont publiées sur Google Play. Budget Assistant et Memoa sont à venir, toujours sans publicité ni compte obligatoire." : "Two premium applications are published on Google Play. Budget Assistant and Memoa are coming soon, still with no advertising or mandatory account.",
  };
